    ...
    public static class UserExtension
    {
        ...
        public static EquipmentAssignment EquipmentViewToEquipment(this EquipmentView _equipment)
        {
            ...
            EquipmentAssignment ev = new EquipmentAssignment()
            {
                ...
                //PatientId = _equipment.PatientId,
                //TherapistId = _equipment.TherapistId,
                //DateTime = _equipment.DateTime,
                //EquipmentId = _equipment.EquipmentId,
                //EquipmentType = _equipment.EquipmentType,
                //IsActive = _equipment.IsActive,
                //Latitude = _equipment.Latitude,
                //Longitude = _equipment.Longitude,
                //Address = _equipment.Address
            };
            return ev;
        }
        ...
        public static Protocol ProtocolViewToProtocol(this ProtocolView _protocol)
        {
            ...
            Protocol pv = new Protocol()
            {
                ...
                Reps = _protocol.Reps,
                //PatientId = _protocol.PatientId,
                //TherapistId = _protocol.TherapistId,
                // EquipmentType = _protocol.EquipmentType,
                FlexUpLimit = _protocol.FlexUpLimit,
                //FlexUpHoldtime = _protocol.FlexUpHoldtime,
                StretchUpHoldtime = _protocol.StretchUpHoldtime,
                FlexDownLimit = _protocol.FlexDownLimit,
                //FlexDownHoldtime = _protocol.FlexDownHoldtime,
                StretchDownHoldtime = _protocol.StretchDownHoldtime,
                //UpReps = _protocol.UpReps,
                //DownReps = _protocol.DownReps,
                //Actuator=_protocol.Actuator,
                //RxId=_protocol.RxId,
                // Time=DateTime.Now
            };
            return pv;
