                ...
                if (!string.IsNullOrEmpty(sessionid))
                {
                    ...
                    if (luser != null)
                    {
                        if (pPatientConfiguration != null && !string.IsNullOrEmpty(pPatientConfiguration.PatientId) && !string.IsNullOrEmpty(pPatientConfiguration.EquipmentType) && !string.IsNullOrEmpty(pPatientConfiguration.DeviceConfiguration) && !string.IsNullOrEmpty(pPatientConfiguration.PatientSide))
                        {
                            ...
                            //if (lpatient == null)
                            //{
                            //    lpatient = INewPatient.GetPatientByPatId(Convert.ToInt32(pPatientConfiguration.PatientId));
                            //}
                            if (lpatient != null)
                            {
                    ...
                    if (luser != null)
                    {
                        if (pPatientConfiguration != null && !string.IsNullOrEmpty(pPatientConfiguration.Rxid) && pPatientConfiguration.patientconfiguration != null && !string.IsNullOrEmpty(pPatientConfiguration.patientconfiguration.PatientId))
                        {
                            ...
                            if (lnewpatient != null)
                            {
                                ...
                                {
                                    //Patient lpatient = IPatient.GetPatientByPatientID(lnewpatient.PatientId);
                                    //if (lpatient != null)
                                    //{
                                    //    pPatientConfiguration.patientconfiguration.PatientFirstName = lpatient.PatientName.Split(new char[0]).Length > 0 ? lpatient.PatientName.Split(new char[0])[0] : lpatient.PatientName;
                                    //}
                ...
                if (!string.IsNullOrEmpty(RXID) && pPatientConfiguration != null)
                {
                    ...
                    if (PatientRx != null && ldevice != null)
                    {
                        ...
                        foreach (ExcerciseProtocol ep in ExcerciseProtocols)
                        {
                            ...
                            //EquipmentExcercise _EquipmentExcercise = EquipmentExcercise.Where(p => p.Limb.ToLower() == pPatientConfiguration.EquipmentType.ToLower() && p.ExcerciseEnum == pPatientConfiguration.DeviceConfiguration).FirstOrDefault();
                            //_protocol.ExcerciseName = _EquipmentExcercise.ExcerciseName;
                            _protocol.ExcerciseEnum = ep.ExcerciseEnum;

                            //ExcerciseProtocol _ExcerciseProtocol = ExcerciseProtocol.Where(p => p.Limb.ToLower() == pPatientConfiguration.EquipmentType.ToLower() && p.ExcerciseEnum == pPatientConfiguration.DeviceConfiguration).FirstOrDefault();
                            ...
                            result = INewPatient.CreateProtocol(_protocol);
                        ...
                        if (pPatientConfiguration != null && !string.IsNullOrEmpty(pPatientConfiguration.PatientId) && !string.IsNullOrEmpty(pPatientConfiguration.SetupId))
                        {
                            ...
                            if (lnewpatient != null)
                            {
                                ...
                                if (lconfig != null)
                                {
                                    ...
                                    //Patient lpatient = IPatient.GetPatientByPatientID(pPatientConfiguration.PatientId);
                                    //if (lpatient != null)
                                    //{
                                    //    lconfig.PatientFirstName = lpatient.PatientName.Split(new char[0]).Length > 0 ? lpatient.PatientName.Split(new char[0])[0] : lpatient.PatientName;
                                    //}
